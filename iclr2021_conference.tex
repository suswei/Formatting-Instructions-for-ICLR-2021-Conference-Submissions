...
%For very few singular models have theoretical RLCTs been cataloged \citep{}. Theoretical RLCTs are certainly not known for modern DNNs where the network weights number on the order of $n$.

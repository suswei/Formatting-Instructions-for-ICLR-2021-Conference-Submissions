...
% \begin{itemize}
%     \item $E_n G_{post}(n)$ corresponding to the full posterior over $\theta$
%     \item $E_n G_{map}(n)$
%     \item $E_n G_{mle}(n)$
%     \item $E_n G_{mcmcrr}(n)$
%     \item Generalization error in \eqref{G_LLB_vfixed}. (don't have a name for it yet)
%     \item Laplace generalization errors
% \end{itemize}

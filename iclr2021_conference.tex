...
The generalization puzzle is one of the central mysteries of deep learning. Theoretical investigations into the matter is an active area of research \cite{neyshabur_exploring_2017}. Some capacity measures are based on workarounds concerning the degenerate Hessian, e.g., \citet{thomas_information_2019}. ???Briefly review following works \cite{maddox_rethinking_2020}, \cite{gao_degrees_2016}, \cite{sun_lightlike_2020}.???

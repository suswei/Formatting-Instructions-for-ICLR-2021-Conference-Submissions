...
To illustrate the relevance of singular learning theory to deep learning, the paper\footnote{The code to reproduce all experiments in the paper will be released on Github. For now, see the zip file.} consists of sections each of which illustrates one key take-away idea. 
...
\begin{figure}[t!]
	...
	\end{center}
	\caption{Realizable and minibatch gradient descent for MAP training.}
...
\begin{figure}[t!]
	...
	\end{center}
	\caption{Non-realizable and full batch gradient descent for MAP training.}
...
\begin{figure}[t!]
	...
	\end{center}
	\caption{Non-realizable and minibatch gradient descent for MAP training.}

...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=0.4]{publication_taskid8.png}
		\includegraphics[scale=0.4]{publication_taskid9.png}
		\includegraphics[scale=0.4]{publication_taskid10.png}
		\includegraphics[scale=0.4]{publication_taskid11.png}
	\end{center}
	\caption{Full batch gradient descent for MAP training. Average generalization error of Laplace approximations are not displayed because they are higher than other approximation schemes by at least an order of magnitude. Each subplot shows a different combination of hidden layers in $g$ (1 or 5) and activation function in $h$ (ReLU or identity). Figure \ref{figure:avg_gen_err_minibatch} is analogous to this setup except minibatch gradient descent was employed to find MAP.}
	\label{figure:avg_gen_err_fullbatch}
\end{figure}
...
The results are displayed in Figures \ref{avg_gen_err_fullbatch} and \ref{avg_gen_err_minibatch}, with the latter in the Appendix. We see that...
In Appendix \ref{appendix:generalizaton}, we also present results analogous to Figure \ref{avg_gen_err_fullbatch} and \ref{avg_gen_err_minibatch} when the data-generating mechanism and the assumed model do not satisfy the condition of realizability. ???summarize the lesson???
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=0.4]{publication_taskid12.png}
		\includegraphics[scale=0.4]{publication_taskid13.png}
		\includegraphics[scale=0.4]{publication_taskid14.png}
		\includegraphics[scale=0.4]{publication_taskid15.png}
	\end{center}
	\caption{Minibatch gradient descent for MAP training. Average generalization error of Laplace approximations are not displayed because they are higher than other approximation schemes by at least an order of magnitude. Each subplot shows a different combination of hidden layers in $g$ (1 or 5) and activation function in $h$ (ReLU or identity). }
	\label{figure:avg_gen_err_minibatch}
\end{figure}

\input{graphics/publication_taskid8.tex}

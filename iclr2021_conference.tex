...
%Classical tools from statistical inference are hence inappropriate for deep neural networks, e.g., one should not ``divide" by the determinant of the Hessian in deep learning. 
...
\begin{table}[h]%
	...
	\begin{tiny}
		\begin{subtable}[t]{2.5in}
			\caption{1 hidden layer(s) in $g$ network, identity activation in $h$ network}			\input{graphics/taskid8.tex}
		\end{subtable}
		\quad
		\begin{subtable}[t]{2.5in}
		...
		\quad
		\begin{subtable}[t]{2.5in}
			\caption{5 hidden layer(s) in $g$ network, ReLU activation in $h$ network}			\input{graphics/taskid11.tex}
		\end{subtable}
	\end{tiny}
\end{table}
...
\begin{table}[h]%
	...
	\quad
	\begin{subtable}[t]{2.5in}
		\caption{5 hidden layer(s) in $g$ network, identity activation in $h$ network}		\input{graphics/taskid1.tex}
	\end{subtable}
	\quad 
	\begin{subtable}[t]{2.5in}
		\caption{1 hidden layer(s) in $g$ network, ReLU activation in $h$ network}
	...
	\quad 
	\begin{subtable}[t]{2.5in}
		\caption{5 hidden layer(s) in $g$ network, ReLU activation in $h$ network}		\input{graphics/taskid3.tex}
	\end{subtable}
	\end{tiny}
\end{table}
...
\begin{table}[h]%
	...
	\begin{tiny}
	\begin{subtable}[t]{2.5in}
		\caption{1 hidden layer(s) in $g$ network, identity activation in $h$ network}		\input{graphics/taskid0.tex}
	\end{subtable}
	\quad
	\begin{subtable}[t]{2.5in}
		\caption{5 hidden layer(s) in $g$ network, identity activation in $h$ network}		\input{graphics/taskid1.tex}
	...
	\quad
	\begin{subtable}[t]{2.5in}
		\caption{1 hidden layer(s) in $g$ network, ReLU activation in $h$ network}		\input{graphics/taskid2.tex}
	\end{subtable}
	\quad
	\begin{subtable}[t]{2.5in}
		\caption{5 hidden layer(s) in $g$ network, ReLU activation in $h$ network}		\input{graphics/taskid3.tex}
